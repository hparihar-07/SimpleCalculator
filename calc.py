...
if __name__=="__main__":
    ...
    minus = Button(gui, text='-',fg='black', bg='orange', command=lambda: press('_'), height=1,width=7)
    ...
    clear = Button(gui, text='Clear',fg='black', bg='orange', command=clear, height=1,width=7)
    clear.grid(row=5, column=1)

    Decimal = Button(gui, text='.',fg='black', bg='orange', command=lambda:press('.'), height=1,width=7)
